...
# Title: 03_perfect-detection
# Subtitle: Reindeer sub-selection
# Description: Detection distance testing using images from the Edmonton Valley Zoo
...
# Load data:
df_reindeer <- read_csv("./data/lookup/valley-zoo-reindeer-position_assumption3.csv")
...
# Time between photos for Woodland Caribou
wc_tbp <- 4.77

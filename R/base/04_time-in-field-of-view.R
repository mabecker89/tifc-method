...
# Title: 04_time-in-field-of-view
# Description: Identify series, add probabilistic gap assignment, and calculate time in front of camera
# Author: Marcus Becker, David J. Huggard

# Previous scripts required: 01_probabilistic-gaps, 02_deployment-timeframes, 03_effective-detection-distance
...
# Probabilistic gaps
df_leave_prob_pred <- read_csv(paste0(processed, "gap-leave-prob_predictions.csv"))

# Time by day summary
df_tbd <- read_csv(paste0(processed, "abmi-cmu_all-years_tbd-summary.csv")) %>%
...
# Full results long:
write_csv(df_tt_full, paste0(processed, "abmi-cmu_all-years_fov-time.csv"))

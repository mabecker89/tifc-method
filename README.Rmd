...
> This repository hosts data, code, and analyses associated with the manuscript *Applying and testing a novel method to estimate animal density from motion-triggered cameras* (Becker et al.)
